...
abstract class WTGTASKSMANAGER_View {
    ...
    public function __construct() {
        global $WTGTASKSMANAGER_Menu;// set in main class as it is needed in many classes
    ...
    */       
    public function render() { 
        ...
        $this->WTGTASKSMANAGER->pageheader( $WTGTASKSMANAGER_Menu[ $admin_page ]['title'], 0);
                               
        // create tab menu for the giving page if the section has two or more pages
        if( !isset( $WTGTASKSMANAGER_Menu[ $admin_page ]['tabmenu'] ) || $WTGTASKSMANAGER_Menu[ $admin_page ]['tabmenu'] === true ) {
            if( $admin_page !== 'main' ) {
