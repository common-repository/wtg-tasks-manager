    ...
    **************************************************************************/
    ...
    function column_ID( $item ) {
        $actions = array(                      
            ...
            'continuetask'    => $this->linkaction( 'wtgtasksmanager_closedtasks', 'continuetask', __( 'Continue this task.', 'wtgtasksmanager' ), __( 'Continue', 'wtgtasksmanager' ), $values = '&task=' . $item->ID ),
        );
