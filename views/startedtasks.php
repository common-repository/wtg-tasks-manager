    ...
    **************************************************************************/
    ...
    function column_ID( $item ) {
        $actions = array(                      
            ...
            'canceltask'    => $this->linkaction( 'wtgtasksmanager_startedtasks', 'canceltask', __( 'Cancel this task.', 'wtgtasksmanager' ), __( 'Cancel', 'wtgtasksmanager' ), $values = '&task=' . $item->ID ),
            'finishtask'    => $this->linkaction( 'wtgtasksmanager_startedtasks', 'finishtask', __( 'Finish this task.', 'wtgtasksmanager' ), __( 'Finish', 'wtgtasksmanager' ), $values = '&task=' . $item->ID ),
        );
