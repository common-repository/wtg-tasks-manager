    ...
    **************************************************************************/
    ...
    function column_ID( $item ) {
        $actions = array(                      
            ...
            'continuetask'    => $this->linkaction( 'wtgtasksmanager_finishedtasks', 'continuetask', __( 'Continue this task.', 'wtgtasksmanager' ), __( 'Continue', 'wtgtasksmanager' ), $values = '&task=' . $item->ID ),
            'closetask'    => $this->linkaction( 'wtgtasksmanager_finishedtasks', 'closetask', __( 'Close this task.', 'wtgtasksmanager' ), __( 'Close', 'wtgtasksmanager' ), $values = '&task=' . $item->ID ),
        );
